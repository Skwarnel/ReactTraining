...
**W głównym folderze repozytorium** uruchom w terminalu/konsoli komendę:

```shell script
npm install
```

Dzięki temu zostaną zainstalowane wszystkie zależności potrzebne do pracy z tym repozytorium.# ReactTraining
